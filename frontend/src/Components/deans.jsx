...
const Deans = () => {
  ...
  useEffect(() => {
    axios.get("https://opensheet.elk.sh/1DKZ5V2yOgGqSze5d0Yt6g881X6tBZ19qoJl8J2-Kh9w/Deans")
      .then(res => {
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {data.map((row, index) => (
                <tr key={row.id || index} className="hover:bg-gray-50">
                  ...
                  <td className="px-3 py-4 text-sm font-medium text-gray-900 text-center">{row.From}</td>
